...
const DSRDetail: React.FC = () => {
  ...
  const handleGenerateMemo = async (e: React.MouseEvent, caseId: string) => {
    e.stopPropagation();
    if (!id) return;
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                ...
                <th className="px-4 py-3">Social Vice Type</th>
                ...
                return (
                  <React.Fragment key={c._id}>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-gray-600">{c.socialViceType || 'None'}</td>
                    ...
                    {isExpanded && (
                      <tr>
                        <td colSpan={10} className="p-0 bg-gradient-to-b from-slate-100 via-slate-50 to-white">
                                ...
                                <div className="px-4 pt-4 pb-3 border-b border-gray-100">
                                  ...
                                  <div className="grid grid-cols-4 md:grid-cols-8 gap-3 text-xs">
                                    ...
                                    <div className="bg-violet-50 rounded-lg p-2.5 border border-violet-100">
                                      <span className="block text-[10px] text-violet-400 uppercase font-semibold mb-0.5">Action Taken By</span>
                                      <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-semibold bg-violet-100 text-violet-700">{c.actionTakenBy || 'Task Force'}</span>
                                    </div>
                                  ...
                                  <div className="flex gap-4 mt-3">
                                    <div>
                                      <span className="block text-[10px] text-slate-400 uppercase font-semibold mb-0.5">Matched PS</span>
                                      {matchedPS ? (
                                    ...
                                    <div>
                                      <span className="block text-[10px] text-slate-400 uppercase font-semibold mb-0.5">Raided By</span>
                                      <span className="text-gray-700 text-xs">{dsr.raidedBy || '—'}</span>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div className="px-4 pt-3 pb-3 border-b border-gray-100">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                      {c.extractedLocations.map((loc, i) => (
                                        <span key={i} className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-semibold border ${
