...
const ZONES: SeedZoneData[] = [
  ...
  // ─── 2. FALAKNUMA ZONE (officers removed) ───────────────────────────────
  {
    name: 'Falaknuma Zone', code: 'FZ',
    stations: [
      { name: 'Asifnagar PS', code: 'PS-ASF', officers: [] },
      { name: 'Macchabolaram PS', code: 'PS-MCB', officers: [] },
      { name: 'Habeebnagar PS', code: 'PS-HBN', officers: [] },
      { name: 'Kalapather PS', code: 'PS-KLP', officers: [] },
      { name: 'Golconda PS', code: 'PS-GLC', officers: [] },
      { name: 'Tappachabutra PS', code: 'PS-TPC', officers: [] },
      { name: 'Bahadurpura PS', code: 'PS-BHP', officers: [] },
