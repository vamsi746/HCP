...
const apiLimiter = _expressratelimit2.default.call(void 0, { windowMs: 1 * 60 * 1000, max: 1000 }); exports.apiLimiter = apiLimiter;
const authLimiter = _expressratelimit2.default.call(void 0, { windowMs: 1 * 60 * 1000, max: 100 }); exports.authLimiter = authLimiter;
